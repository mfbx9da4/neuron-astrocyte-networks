...
def linscale(d, lim):
    """ utility function to linearly scale array d to the interval
    defined by lim
    """
...
def percentError(out, true):
    ...
    (lists and arrays accepted)

    returns percentage of n_wrongs/total_n_outputs *100
    ...
    >>> np.where( x > 5 )
    (array([2, 2, 2]), array([0, 1, 2]))     # Indices (x1,x2,x3), (y1, y2, y3
