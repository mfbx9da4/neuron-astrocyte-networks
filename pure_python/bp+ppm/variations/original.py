...
def graphresults(ngatrainerrs, ngatrainwngs, ngatrainaccs, ngatesterrs, ngatestwngs, ngatestaccs):
...
def main ():
  ngatrainerrs, ngatrainwngs, ngatrainaccs = [],[],[]
  ngatesterrs, ngatestwngs, ngatestaccs = [],[],[]
  isNGA = True
  for T in range(trials):
    global pat; global testpat; pat,testpat = iris.randomdata()
    myNN = NN()
    ...
    print T
  return graphresults(ngatrainerrs, ngatrainwngs, ngatrainaccs, ngatesterrs, ngatestwngs, ngatestaccs)
