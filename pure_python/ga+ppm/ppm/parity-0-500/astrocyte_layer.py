...
class AstrocyteLayer(object):
    def __init__(self, layer_activations, **kwargs):
        ...
        for k in kwargs.keys():
            if k not in params.keys():
                raise KeyError, k + ' not in astro settings ' + params.keys()
            params[k] = kwargs[k]
        """astro settings"""
...
class OutAstroLayer(AstrocyteLayer):
    def __init__(self, layer_activations, input_ws, **kwargs):
        AstrocyteLayer.__init__(self, layer_activations, **kwargs)
        self.in_ws = input_ws
...
#     def __init__(self, layer_activations, output_ws, **kwargs):
#         AstrocyteLayer.__init__(self, layer_activations, **kwargs)
