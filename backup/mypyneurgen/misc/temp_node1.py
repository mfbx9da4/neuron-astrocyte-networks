...
class Node(ProtoNode):
    ...
    def set_activation_type(self, activation_type):
        ...
        elif activation_type == ACTIVATION_THRESHOLD:
            self._activate = threshold
        else:
    ...
    def _set_error_func(self, activation_type):
        ...
        if activation_type == ACTIVATION_SIGMOID:
            ...
            self._error_func = threshold_derivative
        else:
...
def threshold(value, t=0.5):
    """Custom threshold layer"""
    if value > t:
        return 1
    else:
        return 0

def threshold_derivative(value):
    """
    I think this is correct but not totally convinced
