...
#==============================================================================
# data is now saved as a text file to prevent crashing
#==============================================================================
...
#                outputAstrocyteLayer.reset()
    ...
    time_string = datetime.datetime.now().isoformat()[:16]
    # should make new dir each time with os.mkdir
    path = '/home/david/Dropbox/programming/python/ann/mypybrain/output_graphs/'
    ...
    plotPercentageNoErrorBar(all_trn_results, label=side_text, xytxt=(1.02, 1.3))
    plotPercentageNoErrorBar(all_tst_results, label='Final\ntest\nerror\n', xytxt=(1.02, 0.4))
    plt.legend(('Training', 'Test'))
    f.savefig(path+time_string+'_bp'+'_means.png', format='png')
    plt.close()
    ...
    for trial in all_tst_results:
        plt.plot(trial)
    f.savefig(path+time_string+'_bp'+'_all_trials.png', format='png')
